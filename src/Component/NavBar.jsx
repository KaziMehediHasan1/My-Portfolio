...
const NavBar = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full h-20 px-4 text-white bg-black fixed">
      <div>
        <h1 className="text-4xl font-signature ml-2">Kazi Mehedi</h1>
      </div>
      ...
      <div onClick={()=>setNav(!nav)} className="cursor-pointer py-4 z-10 text-gray-500 md:hidden">
        {nav ? <FaBars size={30}></FaBars> : <FaBars size={30}></FaBars> }
      </div>
